# IUS spec file for uwsgi-plugin-php71u
#
# This package is intended to work with uwsgi from EPEL and php71u from IUS.
...
* Tue Mar 28 2017 Carl George <carl.george@rackspace.com> - 2.0.14-1.ius
- Initial package
